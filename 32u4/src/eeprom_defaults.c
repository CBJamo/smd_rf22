...
struct EEPROM_SETTINGS EEMEM rf22_settings =
{
	...
	// 10
	.REG_1C_IF_FILTER_BANDWIDTH                 = 0x8A, // 0x01,
	.REG_1D_AFC_LOOP_GEARSHIFT_OVERRIDE         = 0x44,
	.REG_1E_AFC_TIMING_CONTROL                  = 0x0A,
	.REG_1F_CLOCK_RECOVERY_GEARSHIFT_OVERRIDE   = 0x03,
	.REG_20_CLOCK_RECOVERY_OVERSAMPLING_RATE    = 0x60, // 0x64,
	.REG_21_CLOCK_RECOVERY_OFFSET2              = 0x01,
	.REG_22_CLOCK_RECOVERY_OFFSET1              = 0x55, // 0x47,
	.REG_23_CLOCK_RECOVERY_OFFSET0              = 0x55, // 0xAE,
	.REG_24_CLOCK_RECOVERY_TIMING_LOOP_GAIN1    = 0x02,
	.REG_25_CLOCK_RECOVERY_TIMING_LOOP_GAIN0    = 0xAD, // 0x8F,
	...
	// 3
	.REG_2C_OOK_COUNTER_VALUE_1                 = 0x40, // 0x18,
	.REG_2D_OOK_COUNTER_VALUE_2                 = 0x0A, // 0xBC,
	.REG_2E_SLICER_PEAK_HOLD                    = 0x50, // 0x2C,
	...
	// 1
	.REG_58_CHARGE_PUMP_CURRENT_TRIMMING        = 0x80, // 0x86,
	...
	// 1
	.REG_69_AGC_OVERRIDE1                       = 0x60, // 0x20,

	// 11
	.REG_6D_TX_POWER                            = 0x04, // 0x18,
	.REG_6E_TX_DATA_RATE1                       = 0x20, // 0x0A,
	.REG_6F_TX_DATA_RATE0                       = 0x00, // 0x3D,
	.REG_70_MODULATION_CONTROL1                 = 0x0C,
	.REG_71_MODULATION_CONTROL2                 = 0x23, // 0x00,
	.REG_72_FREQUENCY_DEVIATION                 = 0xC8, // 0x20,
