...
struct EEPROM_SETTINGS EEMEM rf22_settings =
{
	...
	// 10
	.REG_1C_IF_FILTER_BANDWIDTH                 = 0x8B,
	.REG_1D_AFC_LOOP_GEARSHIFT_OVERRIDE         = 0x44,
	.REG_1E_AFC_TIMING_CONTROL                  = 0x02,
	.REG_1F_CLOCK_RECOVERY_GEARSHIFT_OVERRIDE   = 0x00,
	.REG_20_CLOCK_RECOVERY_OVERSAMPLING_RATE    = 0x2F,
	.REG_21_CLOCK_RECOVERY_OFFSET2              = 0x02,
	.REG_22_CLOCK_RECOVERY_OFFSET1              = 0xBB,
	.REG_23_CLOCK_RECOVERY_OFFSET0              = 0x0D,
	.REG_24_CLOCK_RECOVERY_TIMING_LOOP_GAIN1    = 0x17,
	.REG_25_CLOCK_RECOVERY_TIMING_LOOP_GAIN0    = 0xFF,

	// 1
	.REG_27_RSSI_THRESHOLD                      = 0x1E,

	// 1
	.REG_2A_AFC_LIMITER                         = 0x50,

	// 3
	.REG_2C_OOK_COUNTER_VALUE_1                 = 0x40,
	.REG_2D_OOK_COUNTER_VALUE_2                 = 0x0A,
	.REG_2E_SLICER_PEAK_HOLD                    = 0x50,

	// 1
	.REG_30_DATA_ACCESS_CONTROL                 = 0x8D,

	// 21
	.REG_32_HEADER_CONTROL1                     = 0x80,
	.REG_33_HEADER_CONTROL2                     = 0x42,
	...
	.REG_3F_CHECK_HEADER3                       = 0xAA,
	.REG_40_CHECK_HEADER2                       = 0x00,
	.REG_41_CHECK_HEADER1                       = 0x00,
	.REG_42_CHECK_HEADER0                       = 0x00,
	.REG_43_HEADER_ENABLE3                      = 0x00,
	.REG_44_HEADER_ENABLE2                      = 0x00,
	.REG_45_HEADER_ENABLE1                      = 0x00,
	.REG_46_HEADER_ENABLE0                      = 0x00,

	// 1
	.REG_58_CHARGE_PUMP_CURRENT_TRIMMING        = 0xED,

	// 1
	.REG_60_CHANNEL_FILTER_COEFFICIENT_ADDRESS  = 0xA0,

	// 1
	.REG_62_CRYSTAL_OSCILLATOR_POR_CONTROL      = 0x04,

	// 1
	.REG_69_AGC_OVERRIDE1                       = 0x60,

	// 11
	.REG_6D_TX_POWER                            = 0x04,
	.REG_6E_TX_DATA_RATE1                       = 0x41,
	.REG_6F_TX_DATA_RATE0                       = 0x89,
	.REG_70_MODULATION_CONTROL1                 = 0x0C,
	.REG_71_MODULATION_CONTROL2                 = 0x23,
	.REG_72_FREQUENCY_DEVIATION                 = 0xA0,
	.REG_73_FREQUENCY_OFFSET1                   = 0x00,
	.REG_74_FREQUENCY_OFFSET2                   = 0x00,
	.REG_75_FREQUENCY_BAND_SELECT               = 0x53,
	.REG_76_NOMINAL_CARRIER_FREQUENCY1          = 0x64,
	.REG_77_NOMINAL_CARRIER_FREQUENCY0          = 0x00,
	...
	// 3
	.REG_7C_TX_FIFO_CONTROL1                    = 0x35,
	.REG_7D_TX_FIFO_CONTROL2                    = 0x0B,
	.REG_7E_RX_FIFO_CONTROL                     = 0x35,
};
